...
public class MysqlGenerator {
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                // 全局配置
                new GlobalConfig().setOutputDir("e:/test/")// 输出目录
                ...
                new DataSourceConfig().setDbType(DbType.MYSQL)// 数据库类型
                        ...
                        }).setDriverName("com.mysql.jdbc.Driver").setUsername("root").setPassword("111111")
                        .setUrl("jdbc:mysql://localhost:3306/sys?useUnicode=true&characterEncoding=UTF-8&useSSL=false&zeroDateTimeBehavior=convertToNull"))
                .setStrategy(
                        // 策略配置
                        new StrategyConfig()
                                ...
                                // 自定义 公共字段
                                //自定义 Enity 父类
                                .setSuperEntityClass("org.redin.po.BasePo")
